...
function RankingsPage() {
 ...
 filtered = Object.values(groupedByAge).flatMap(group => group.sort((a, b) => {
 ...
 filtered = Object.values(groupedByStyle).flatMap(group => group.sort((a, b) => {
 const aRounded = a.roundedPercentage ?? calculateRoundedPercentage(a.totalScore, a.judgeCount);
 const bRounded = b.roundedPercentage ?? calculateRoundedPercentage(b.totalScore, b.judgeCount);
 if (bRounded !== aRounded) return bRounded - aRounded;
 const aRaw = a.rawAverageScore ?? a.averageScore;
 ...
 <div className="w-16 h-16 border-2 border-[rgba(192,192,192,0.2)] border-t-[var(--chrome-mid)] rounded-full animate-spin mx-auto mb-4"></div>
 ...
 return (
 <div className="min-h-screen avalon-mesh flex items-center justify-center">
 <div className="text-center glass-panel border border-[rgba(192,192,192,0.22)] p-8 rounded-xl">
 ...
 <header className="glass-panel backdrop-blur-sm border-b border-[rgba(192,192,192,0.15)]">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="flex justify-between items-center py-4">
 <div className="flex items-center space-x-4">
 <BrandLogo brand="avalon" size={40} priority />
 <div>
 <h1 className="font-display text-2xl chrome-text leading-none">Rankings</h1>
 <p className="text-sm text-gray-400 mt-1">Performance results and awards</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="text-center">
 <div className={`text-2xl font-bold ${theme === 'dark' ? 'text-[var(--chrome-mid)]' : 'text-[var(--chrome-dark)]'}`}> {totalPerformances}
 </div>
 ...
 <div className={`${themeClasses.metricCardBg} ${themeClasses.cardRadius} p-6 ${themeClasses.cardShadow} border ${themeClasses.metricCardBorder} hover:shadow-2xl transition-all duration-300 transform hover:scale-105`}>
 <div className="text-center">
 <div className={`text-2xl font-bold ${theme === 'dark' ? 'text-[var(--chrome-mid)]' : 'text-[var(--chrome-dark)]'}`}> {studios}
 </div>
 ...
 <div className={`${themeClasses.metricCardBg} ${themeClasses.cardRadius} p-6 ${themeClasses.cardShadow} border ${themeClasses.metricCardBorder} hover:shadow-2xl transition-all duration-300 transform hover:scale-105`}>
 <div className="text-center">
 <div className={`text-2xl font-bold ${theme === 'dark' ? 'text-[var(--chrome-mid)]' : 'text-[var(--chrome-dark)]'}`}> {ageCategories}
 </div>
 <div className={`text-sm ${themeClasses.textSecondary} font-medium`}>Age Categories</div>
 </div>
 </div>
 </div> {/* Filters */}
 <div className={`${themeClasses.cardBg} ${themeClasses.cardRadius} shadow-xl p-8 mb-8 border ${themeClasses.cardBorder}`}> {/* Event Filter */}
 <div className="mb-6">
 <label className={`block text-sm font-semibold ${themeClasses.textPrimary} mb-3`}>Filter by Event</label>
 <select
 value={selectedEventId}
 onChange={(e) => setSelectedEventId(e.target.value)}
 className={`w-full px-4 py-3 border-2 ${themeClasses.inputBorder} ${themeClasses.cardRadius} focus:ring-2 focus:ring-[rgba(192,192,192,0.45)] focus:border-[rgba(192,192,192,0.5)] transition-all duration-200 font-medium ${themeClasses.inputBg} ${themeClasses.textPrimary}`}
 >
 ...
 <div className={`text-center py-12 ${themeClasses.cardBg} ${themeClasses.cardRadius} shadow-lg border border-[rgba(192,192,192,0.22)]`}>
 ...
 <tbody> {filteredRankings.map((ranking) => {
 ...
 <div className={`inline-flex items-center px-3 py-1 ${themeClasses.cardRadius} text-sm font-bold border ${getRankBadgeColor(displayRank)}`}> #{displayRank}
 </div>
 </td>
 <td className="py-4 px-6"> {ranking.itemNumber ? (
 <div className={`inline-flex items-center px-3 py-1 ${themeClasses.cardRadius} text-sm font-bold btn-chrome text-[#050505] border border-[rgba(192,192,192,0.35)] shadow-md`}> Item {ranking.itemNumber}
 </div> ) : (
 ...
 <span className={`text-sm ${themeClasses.textSecondary}`}>{ranking.itemStyle}</span> {ranking.mastery && (
 <span className={`inline-flex items-center px-2 py-1 ${themeClasses.cardRadius} text-xs font-medium bg-emerald-700 text-emerald-200`}> {ranking.mastery}
 </span> )}
 </div>
 </td>
 <td className="py-4 px-6">
 <div className={`font-medium ${themeClasses.textPrimary}`}>{ranking.contestantName}</div> {ranking.studioName && (
 <div className={`text-xs ${themeClasses.textSecondary} mt-1`}>{ranking.studioName}</div> )}
 </td>
 <td className="py-4 px-6">
 <div className={`inline-flex items-center px-3 py-1 ${themeClasses.cardRadius} text-xs font-bold bg-blue-700 text-blue-200 border border-blue-500`}> {ranking.performanceType}
 </div>
 </td>
 <td className="py-4 px-6">
 <div className={`inline-flex items-center px-3 py-1 ${themeClasses.cardRadius} text-xs font-bold bg-[rgba(192,192,192,0.08)] text-[var(--chrome-mid)] border border-[rgba(192,192,192,0.22)]`}> {ranking.ageCategory}
 </div>
 </td>
 <td className="py-4 px-6">
