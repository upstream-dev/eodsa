...
function EventDashboardContent() {
 ...
 const data = await response.json();
 if (data.success) {
 const openEvents = data.events.filter((event: Event) => event.status === 'registration_open' || event.status === 'upcoming'
 );
 ...
 <Link 
 href="/dancer-login" className="block w-full px-6 py-3 btn-chrome !rounded-full text-white rounded-xl transition-all duration-300 font-semibold" >
 Dancer Login
 </Link>
 <Link 
 href="/studio-login" className="block w-full px-6 py-3 btn-outline-chrome !rounded-full text-white rounded-xl transition-all duration-300 font-semibold" >
 Studio Login
 </Link>
 <Link 
 href="/" className="block w-full px-6 py-3 btn-outline-chrome !rounded-full text-gray-300 rounded-xl transition-all duration-300 font-semibold" >
 Back to Home
 </Link>
 </div>
 </div>
 ...
 <div className="space-y-3">
 <Link 
 href="/register" className="block w-full px-6 py-3 btn-chrome !rounded-full text-white rounded-xl transition-all duration-300 font-semibold" >
