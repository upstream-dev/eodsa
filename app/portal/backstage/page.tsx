...
export default function BackstagePortalPage() {
 ...
 return (
 <AuthPortalLayout title="Backstage Portal" subtitle="Avalon Competition Management">
 <div className="p-8">
 <p className="text-[var(--muted-foreground)] text-sm text-center mb-6"> Control performance order and live event flow
 ...
 {isLoading ? 'Signing in...' : 'Sign in to Backstage'}
